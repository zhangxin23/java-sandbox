...
public class MailReceiver {
    ...
    private void parseNewMessage(Message message) throws IOException, MessagingException {
        Object content = message.getContent();

        // 处理多部分邮件
        if (content instanceof Multipart) {
            handleNewMultipart((Multipart) content);
        } else {
            handleNewPart(message);
        }
    ...
    private void handleNewMultipart(Multipart multipart) throws MessagingException, IOException {
        for (int i = 0, n = multipart.getCount(); i < n; i++) {
            handleNewPart(multipart.getBodyPart(i));
        }
    }

    private void handleNewPart(Part part) throws MessagingException, IOException {
...
//        String charset = contentType.substring(start + 1, end);
...
//        System.out.println(content);
    ...
    private void printNewMail(Message message) throws MessagingException {
        try {
    ...
    private void getNewMail() throws MessagingException {
        ...
        for (int index = 0; index < mailArrayLength; index++) {
            try {
                ...
                if(this.isNew()) {
                    ...
                    this.printNewMail(this.currentMessage);
    ...
    public static void main(String[] args) throws Exception {
        ...
        receiverInfo.setMailServerHost("imap.163.com");
