...
public class bstar
{
    ...
    private IZLoopHandler voterFn;    //  Voting socket handler
    private Object voterArg;              //  Arguments for voting handler
    private IZLoopHandler activeFn;   //  Call when become active
    private Object activeArg;             //  Arguments for handler
    private IZLoopHandler passiveFn;  //  Call when become passive
